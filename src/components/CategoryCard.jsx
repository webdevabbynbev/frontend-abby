...
export function CategoryCard({ title, image }) {
  return (
    <div
      className="container w-full min-w-[100px] flex-col items-center justify-center
    ...
    >
      ...
      <div className="title">
      <h3 className="items-center justify-center text-center font-normal text-xs text-primary-700">{title}</h3>
      </div>
    </div>
  );
}
