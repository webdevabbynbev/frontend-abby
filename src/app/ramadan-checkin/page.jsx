  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl text-center relative overflow-hidden flex flex-col items-center">
        <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-pink-500 via-purple-500 to-amber-500"></div>
        ...
        {showResult ? (
          ...
          <button
            ...
            disabled={mustSpin}
            className="w-full rounded-xl bg-gradient-to-r from-pink-600 to-purple-600 px-4 py-3 text-white font-bold shadow-lg hover:scale-[1.02] transition disabled:opacity-70 disabled:cursor-not-allowed"
          >
...
export default function RamadanCheckinPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 relative">
      ...
      {/* --- HEADER --- */}
      <div className="mb-6 rounded-3xl border border-pink-100 bg-gradient-to-br from-pink-50 via-white to-amber-50 p-6 shadow-sm flex flex-col md:flex-row items-center justify-between gap-4">
        <div>
        ...
        {status.rewardEligible ? (
          <button
            ...
            className="animate-bounce bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold py-3 px-6 rounded-full shadow-lg border-2 border-white ring-2 ring-purple-200"
          >
          ...
          status.checkedCount + status.exemptCount >= TOTAL_DAYS && (
            <div className="bg-red-50 text-red-600 px-4 py-2 rounded-lg text-xs font-medium border border-red-200 text-center max-w-[200px]">
                          ...
                          <div className="flex flex-wrap gap-2 mb-4">
                            {[
                              ...
                              <button
                                ...
                                className={`flex-1 min-w-[80px] py-2 px-3 text-xs rounded-lg border transition font-medium ${
